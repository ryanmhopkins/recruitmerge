...
function App(){
  ...
  const connect=()=>chrome.tabs.create({url:`https://recruitmerge.com/extension/connect?extensionId=${encodeURIComponent(chrome.runtime.id)}`});
